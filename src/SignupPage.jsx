...
function SignInForm() {
  ...
  return (
    ...
    {preloading ? (
        ...
        <Mainlayout>
      <div
        className=" container w-[100%] md:w-[60%] h-[auto] pb-9 lg:h-[auto] lg:pb-10 md:h-[auto] bg-slate-200 shadow-md rounded-lg mt-9 mx-auto pt-16"
      >
             <h1 className=" text-4xl font-medium text-slate-950 px-6 pb-6 text-center">Get Started</h1>
        <form
        ...
        >
            ...
            <div className="flex justify-between gap-1 md:gap-0 w-[85%] sm:w-[60%] lg:w-[70%]  h-[20] mb-3">
              <h2 className=" text-base font-medium">Already have an Account?</h2>
